...
> 𓏺 𝗰𝗼𝗺𝗽𝗹𝗲𝘁𝗲𝗱 𝗙𝗶𝘀𝗵𝗶𝗻𝗴 𝗦𝗼𝘂𝗿𝗰𝗲 . ؓ⇲


   𓏺 𝗿𝗶𝗴𝗵𝘁𝘀 .( @L_F_W .^. @L_R_W )   
...
𓏺 - ⎱𝗨𝘀𝗲𝗿𝗡𝗮𝗺𝗲 ➫ @ (@{username})
    ...
    ''')
                    ...
                    await fifthon.send_message(event.chat_id, f''' متأح أۅٛ خأصيه {username}
     :
    {str(eee)}''')
                    if "A wait of" in str(eee):
                        break
                    else:
                        await fifthon.send_message(event.chat.id, " متأح أۅٛ خأصيه !")
            else:
                pass
            trys += 1
        ...
        isclaim.append("off")
        trys = ""
        await event.client.send_message(event.chat_id, "! تم خاوه")
...
𓏺 - ⎱𝗨𝘀𝗲𝗿𝗡𝗮𝗺𝗲 ➫ (@{username})
    ...
    {str(eee)}''')
            ...
            isclaim.clear()
            isclaim.append("off")
            await fifthon.send_message(event.chat_id, "تم الانتهاء من التثبيت ايزي")
...
''')
                ...
                await fifthon.send_message(event.chat_id, f''' مزاد او مبند {username}
     :
    {str(eee)}''')
Threads=[] 
for t in range(100):
